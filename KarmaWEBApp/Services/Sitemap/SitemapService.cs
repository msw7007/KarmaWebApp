namespace KarmaWEBApp.Services
{
    ...
    public class SitemapService : SitemapGenerator, ISitemapService
    {
        ...
        protected virtual IReadOnlyCollection<SitemapNode> GetSitemapNodes()
        {
            ...
            nodes.Add(
               new SitemapNode(this.urlHelper.AbsoluteRouteUrl(HomeControllerRoute.GetRegChar))
               {
                   Priority = 0.9
               });
            nodes.Add(
               new SitemapNode(this.urlHelper.AbsoluteRouteUrl(HomeControllerRoute.GetAbsForm))
               {
                   Priority = 0.9
               });
